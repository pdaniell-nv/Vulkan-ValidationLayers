...
bool ValidateSampler(const VkSampler, const layer_data *);
bool ValidateImageUpdate(VkImageView, VkImageLayout, VkDescriptorType, const layer_data *, const char *func_name,
...
bool ValidateUpdateDescriptorSets(const debug_report_data *, const layer_data *, uint32_t,
...
void PerformUpdateDescriptorSets(const layer_data *, uint32_t, const VkWriteDescriptorSet *, uint32_t,
