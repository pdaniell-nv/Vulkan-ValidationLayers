...
//////CoreChecks::cvdescriptorset::DescriptorSet *GetSetNode(const layer_data *, VkDescriptorSet);
...
//////VkResult GetPDImageFormatProperties2(layer_data *, const VkPhysicalDeviceImageFormatInfo2 *,
